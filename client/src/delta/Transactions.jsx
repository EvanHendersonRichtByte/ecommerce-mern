          ...
          <div className="jumbotron">
            <div className=" kryptonite-text container">
              ...
              <p className="kryptonite-text">
                Please confirm or decline user's transaction below!
              </p>
            </div>
          </div>
            ...
            {this.state.transactions.map(data => (
              <div style={{marginBottom: "40px"}} className="row" key={data._id}>
                <div className="col-md-12 border rounded border-primary">
                  <h2 className="kryptonite-text text-center">
                  ...
                  <div className="row">
                    ...
                    <img
                      className="col-md-6"
                      src={`${process.env.PUBLIC_URL}/uploads/transactions/${data.image}`}
                    />
                  </div>
                  <div className="row">
                    <div className="col-md-6">
                  ...
                  {data.status ? (
                    <button
                      disabled
                      className="kryptonite-button btn btn-block btn-outline-secondary"
                    >
                      {data.status}
                    </button>
                  ) : (
                    <Fragment>
                      <form onSubmit={() => this.handleAccData(data)}>
                        <button
                          type="submit"
                          className="kryptonite-button btn btn-block btn-outline-success"
                        >
                          Accept
                        </button>
                      </form>
                      <form onSubmit={() => this.handleDecData(data)}>
                        <button
                          type="submit"
                          className="kryptonite-button btn btn-block btn-outline-danger"
                        >
                          Decline
                        </button>
                      </form>
