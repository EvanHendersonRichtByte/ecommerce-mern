          ...
          <div className="container-fluid col-md-8">
            <div className="row">
              ...
              <div className="col-lg-12">
                ...
                >
                  <h4 className="kryptonite-navbar-icon kryptonite-text text-primary">
                    blogs
                  </h4>
                </div>
                      ...
                      <div className="card-body">
                        <h4 className="card-title text-center">
                          <p className="text-primary">
                            How to push up like an russian?
                          </p>
                        </h4>
                        <h5 className="text-primary">By: Johnpaul Weissnat</h5>
                        <p className="card-text text-primary">
                          Maiores magni doloribus similique quos reiciendis qui
                          aut.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="col-lg-4 " style={{ marginBottom: "50px" }}>
                    <div className="card h-100  border border-primary">
                      ...
                      <div className="card-body">
                        <h4 className="card-title text-center">
                          <p className="text-primary">
                            Being spec-ops in antartica
                          </p>
                        </h4>
                        <h5 className="text-primary">By: Cpt.O'Conner</h5>
                        <p className="card-text text-primary">
                          Totam sunt dolorem repudiandae incidunt vitae aut.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4 " style={{ marginBottom: "50px" }}>
                    <div className="card h-100  border border-primary">
                      ...
                      <div className="card-body">
                        ...
                        <p className="card-text text-primary">
                          Maxime corrupti non voluptatem aspernatur aliquid
                          repudiandae nam. Suscipit repellendus sit qui et sed
                          tenetur.
                        </p>
                      </div>
                    </div>
                ...
                >
                  <h4 className="kryptonite-navbar-icon kryptonite-text text-warning">
                    exclusive product
                  </h4>
                </div>
                    ...
                    <div className="card h-100  border border-warning">
                      ...
                      <div className="card-body">
                        ...
                        <p className="card-text text-warning">
                          Aperiam exercitationem et unde sed. Nihil quia et.
                          Officia voluptatum earum distinctio illum blanditiis
