...
export default class ProofPayment extends Component {
  ...
  handleFormData(e) {
    ...
    axios
      .put(
        "http://localhost:2020/transaction/" + this.props.transactionId,
        formData,
        config
      )
      .then(res => {
  ...
  render() {
    ...
    return (
      <Modal
        ...
        contentLabel="ProofOfPayment"
      >
        <div className="file-upload-wrapper">
          <h5 className="kryptonite-text text-dark text-center">
            Upload Proof of Payment
          </h5>
          <h6 className="kryptonite-text text-dark text-center">
            Please transfer to the account below
          </h6>
          <p className="kryptonite-text text-dark text-center">
            4111 1111 1111 1111
          </p>
          <form onSubmit={this.handleFormData}>
            <input
              className="file-upload col-md-12"
              type="file"
              name="image"
            ...
            <button
              type="submit"
              className="kryptonite-button btn btn-primary btn-block"
            >
              Submit
            </button>
            <div>
